...
#sequence = [6, 0, 12, 8, 3, 10, 4, 7]

#Create a new empty arrray and index

index = 0 
new_sequence = []

#Create a conditional loop that can perform the number swapping along the entire array
...
#Create a program that would push the new sequence into a new array

#create a program that would print the new sequence