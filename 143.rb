...
if my_pets["dogs"] == 2         # the issue was that the hash item dogs was not being reffered to in the code. 
                                # originally the code was comparing the 2nd item "fish" and "dogs"
  puts "I have 2 dogs!"
end